...
public class JsonMEDemoMIDlet extends MIDlet{
...
// Obj is a typical class that implements JSONString.        
		...
		class Obj implements JSONString {
			...
			public Obj(String string, long n, boolean b) {
				this.aString = string;
				this.aNumber = n;
				this.aBoolean = b;
			}
			...
			public String toJSONString() {
				return "{" + JSONObject.quote(this.aString) + ":" +
					JSONObject.numToString(this.aNumber) + "}";
			}
		...
		try {
			...
			jj.key("big").value(12345678);
			jj.key("small").value(-12345678);
			...
			System.out.println("String: " + j.getNum("String"));
			...
			j = new JSONObject("{string: \"98\", long: 214748, int: 2147483, longer: 9223372, double: 922337203}");
			System.out.println(j.toString(4));
			...
			System.out.println("\ngetDouble");
			System.out.println("int    " + j.getNum("int"));
			System.out.println("long   " + j.getNum("long"));
			System.out.println("longer " + j.getNum("longer"));
			System.out.println("double " + j.getNum("double"));
			System.out.println("string " + j.getNum("string"));

			j.put("good sized", 9223372036854775807L);
			System.out.println(j.toString(4));

			a = new JSONArray("[2147483, 2147483, 922337203, 922337203]");
			...
			try {
				System.out.println(j.getNum("stooge"));
			} catch (Exception ex) {
				ex.printStackTrace();
			}
			System.out.print("Exception: ");
			try {
				System.out.println(j.getNum("howard"));
			} catch (Exception ex) {
				ex.printStackTrace();
			}
			System.out.print("Exception: ");
