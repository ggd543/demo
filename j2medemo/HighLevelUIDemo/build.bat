@echo off
SET MIDlet_Name=HighLevelUIDemo
@ECHO OFF
...
SET JSR75_1.1=%WTK_HOME%\lib\jsr75_1.0.jar
SET JSR135_1.1=%WTK_HOME%\lib\jsr135_1.1.jar
SET MIDP_CP=%MIDP_API_2_0%;%CLDC_API_1_1%;%JSR75_1.1%;%JSR135_1.1%
