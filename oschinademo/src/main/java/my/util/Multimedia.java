...
public abstract class Multimedia {
    ...
    public final static ImgHandler g_img_handler = new JavaImgHandler();
     ...
     * @throws IOException
     */
    public static void saveImage(File img, String dest, int width, int height) throws IOException {
        g_img_handler.scale(img, new File(dest), width, height);
    }
