 ...
 *
 * @author auto create
 * @since 1.0, 2010-11-15 10:39:59.0
 */
@ApiClass("Shop")
public class Shop extends TaobaoObject {

	private static final long serialVersionUID = 1519939487726561511L;

	
	/** 
	 * 总橱窗数量，对于C卖家返回总橱窗数，对于B卖家返回0
	 **/
	@ApiField("all_count")
	...
	/** 
	 * 已用的橱窗数量，对于C卖家返回已使用的橱窗数，对于B卖家返回-1
	 **/
	@ApiField("used_count")
