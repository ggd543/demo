 ...
 */
public class TaobaokeItemsGetRequest implements TaobaoRequest {
...
5goldencrown(五黄冠)
	...
	public Map<String, String> getTextParams() {		
		textParams.put("area", this.area);
		textParams.put("auto_send", this.autoSend);
		textParams.put("cash_coupon", this.cashCoupon);
		textParams.put("cash_ondelivery", this.cashOndelivery);
		textParams.put("cid", this.cid);
		textParams.put("end_commissionNum", this.endCommissionNum);
		...
		textParams.put("end_totalnum", this.endTotalnum);
		textParams.put("fields", this.fields);
		textParams.put("guarantee", this.guarantee);
		textParams.put("keyword", this.keyword);
		textParams.put("mall_item", this.mallItem);
		textParams.put("nick", this.nick);
		textParams.put("onemonth_repair", this.onemonthRepair);
		textParams.put("outer_code", this.outerCode);
		textParams.put("overseas_item", this.overseasItem);
		textParams.put("page_no", this.pageNo);
		textParams.put("page_size", this.pageSize);
		textParams.put("real_describe", this.realDescribe);
		textParams.put("sevendays_return", this.sevendaysReturn);
		textParams.put("sort", this.sort);
		textParams.put("start_commissionNum", this.startCommissionNum);
		...
		textParams.put("start_totalnum", this.startTotalnum);
		textParams.put("vip_card", this.vipCard);
		return textParams;
	}
