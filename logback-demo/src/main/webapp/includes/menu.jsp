...
<table class="nav">
    ...
    <tr><td class="sexy"><a href="reload.jsp" class="sexy"><b>Reload config</b></a></td></tr>
    <tr><td class="sexy"><a href="Logout.do" class="sexy">logout</a></td></tr>
    <tr><td class="sexy"><a href="hello" class="sexy">hello</a></td></tr>
    <tr><td><center><%@include file="user.jsp" %></center></td></tr>
</table>
